...
const url=en.nodes.get('status').children[2].href;
...
assert.equal(en.nodes.get('status').children[2].href,url);
assert.match(en.nodes.get('status').children[2].textContent,/下载/);
